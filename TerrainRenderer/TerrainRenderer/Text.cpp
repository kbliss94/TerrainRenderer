...
namespace TerrainRenderer
{
		...
		D3DXMATRIX baseViewMatrix)
	{
		...
		result = m_Font->Initialize(device, "../TerrainRenderer/data/fontdata.txt", L"../TerrainRenderer/data/font.dds");
		if (!result)
		{
	...
	bool Text::Render(ID3D11DeviceContext* deviceContext, FontShader* FontShader, D3DXMATRIX worldMatrix, D3DXMATRIX orthoMatrix)
	{
		bool result;
	...
	bool Text::RenderSentence(SentenceType* sentence, ID3D11DeviceContext* deviceContext, FontShader* FontShader, D3DXMATRIX worldMatrix,
